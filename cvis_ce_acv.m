function cvis_ce_acv()
    ...
    % from cvis_ce_acv_en_out nbatches = 1000
    % v_CV_EN/v0_MC
    v_CV_EN__MC = 0.585055048742276;
    % v_IS_EN/v0_MC
    v_IS_EN__MC = 0.780165541467263;
    ...
    plot(a,v_CV'/v0_MC,'-d',a,v_IS'/v0_MC,'-v',a,ones(1,length(a)),...
        a,v_CV_EN__MC*ones(1,length(a)),'-*',a,v_IS_EN__MC*ones(1,length(a)),'-o')
    set(gca,...
        'Units','normalized',...
        'FontUnits','points',...
        'FontWeight','normal',...
    ...
    legend({'$Var_{\hat{q}}[\mathcal{Q}^{MF}_{\hat{q},n}]$','$Var_{\hat{q}}[\mathcal{Q}^{MF\mbox{-}1}_{\hat{q},n}]$','$Var_{\hat{q}}[\mathcal{Q}^{MFIS}_{\hat{q},n}]$','$Var_{\hat{q}}[\bar{\mathcal{Q}}^{MF}_{\hat{q},K}]$','$Var_{\hat{q}}[\bar{\mathcal{Q}}^{MF\mbox{-}1}_{\hat{q},K}]$'},...
        'interpreter','latex',...
        'FontSize',fontsize,...
        'FontName','Times',...
        'Location','Best')
